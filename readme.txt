...
The font is Taamey Ashkenaz by Culmus Project, available in the Open Siddur font package here: https://opensiddur.org/help/fonts/
Unfortunately in different word processing software the font may render incorrectly (LibreOffice in particular).
Also because of the changes in text direction certain issues may occur with parentheses and text justification.
If you adapt the word file at all, I would suggest checking these in particular and saving as a PDF.

I hope these word files help others stay warm in gloves while davening in a safe way this year.